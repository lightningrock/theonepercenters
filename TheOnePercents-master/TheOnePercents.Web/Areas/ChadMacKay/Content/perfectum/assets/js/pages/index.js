...
//$(function () {
//    loadCircleStatsPartial();
//});

//function loadCircleStatsPartial() {
//    $.ajax({
//        type: "GET",
//        url: AJEX_GET_CIRCLE_STATS_PARTIAL,
//        cache: false,
//        success: function (result) {
//            $('#circleStatsDiv').html(result);
//        },
//        error: function (xhr, ajaxOptions, thrownError) {
//            error_message(xhr, ajaxOptions, thrownError);
//        }
//    });
//}

//function error_message(xhr, ajaxOptions, thrownError) {
//	var unique_id = $.gritter.add({
//		// (string | mandatory) the heading of the notification
//		title: 'Buy Perfectum!',
//		// (string | mandatory) the text inside the notification
